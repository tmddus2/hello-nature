...
package com.hellonature.google.ar.core.examples.java.ml.classification

import android.media.Image
import android.util.Log
import com.hellonature.google.ar.core.examples.java.ml.MainMLActivity
import com.hellonature.google.ar.core.examples.java.ml.classification.utils.ImageUtils
import com.hellonature.google.ar.core.examples.java.ml.classification.utils.ImageUtils.toByteArray
import com.hellonature.google.ar.core.examples.java.ml.classification.utils.VertexUtils.calculateAverage
import com.hellonature.google.ar.core.examples.java.ml.classification.utils.VertexUtils.rotateCoordinates
import com.hellonature.google.ar.core.examples.java.ml.classification.utils.VertexUtils.toAbsoluteCoordinates
 ...
 */
class GoogleCloudVisionDetector(val activity: MainMLActivity) : ObjectDetector(activity) {
  companion object {
  ...
  override suspend fun analyze(image: Image, imageRotation: Int): List<DetectedObjectResult> {
    // `image` is in YUV (https://developers.google.com/ar/reference/java/com.hellonature.google.ar.core.Frame#acquireCameraImage()),
