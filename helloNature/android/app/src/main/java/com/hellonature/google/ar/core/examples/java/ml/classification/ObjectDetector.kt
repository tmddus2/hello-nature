...
import com.hellonature.google.ar.core.examples.java.ml.third_party.YuvToRgbConverter
...
abstract class ObjectDetector(val context: Context) {
   ...
   * https://developers.google.com/ar/reference/java/com.hellonature.google.ar.core.Frame#acquireCameraImage()
   *
